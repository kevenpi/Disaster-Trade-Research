...
tbl_sec <- paste0("<table><tr><th>sector (vs chemicals)</th>",
...
<h2>3. Joint specification (all four types at once) &mdash; value</h2>
<p>Each type conditional on the other three; robustness for co-occurring
